...
- `#workbench`, `#library`, `#discover`, `#governance`, and `#dictionary` are directly migrated and browser-verified. Continue with tasks/export/files, followed by settings and detail/history/readers as tracked in `docs/AGENT_MAP.md`.
