...
- `#workbench`, `#library`, `#discover`, `#governance`, `#dictionary`, and `#tasks` are directly migrated and browser-verified. Continue with export/files, followed by settings and detail/history/readers as tracked in `docs/AGENT_MAP.md`.
