...
| 4 | `#governance`, `#dictionary` | feature-local components | old governance/dictionary layout selectors replaced per component | governance migrated / dictionary pending |
