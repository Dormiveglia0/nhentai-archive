...
let previousShelf: "all" | "reading" | "recent" = "reading";
      ...
      {!library.emptyLibrary ? (
        <section className="library-recent-section">
          ...
          {shelf!=="all" && <SelectionStage selection={shelf} className="folio-library-shelves">
            <ContinueReadingRow onPickTag={library.pickTag} title={shelf === "reading" ? "继续阅读" : "最近添加"} works={shelf === "reading" ? library.continueReading : library.recentAdded} blurCovers={blurCovers} />
          </SelectionStage>}
        </section>
      ) : null}
